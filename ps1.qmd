...
acs_hist <- ggplot(commuters, aes(x = `Commute Time (mins)`)) +
  ...
  labs(x = "Commute Time (mins)",
       y = "Individuals who have a Commute",
       title = "Commute Times for Individuals (in minutes)") +
...
3. The mean is simply the mean of the sample without accounting for how we might 
